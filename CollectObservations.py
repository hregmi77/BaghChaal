...
def generate_data(random_play_data=True, minmax_play_data=True):
    if random_play_data:
        generate_random_play_data()
    if minmax_play_data:
        generate_minmax_play_data()